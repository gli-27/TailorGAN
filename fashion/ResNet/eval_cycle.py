...
gen.load_state_dict(torch.load('./trainedModel/cycleGB15_18.ckpt',map_location={'cuda':'cpu'}))
gen.cuda()
...
for i,data in enumerate(loader):
    ...
    for i in range(batch_size):
        ...
        imsave('./results/oneout/'+str(cnt)+'_cycle5to1_orig.jpg', orig_img)
        imsave('./results/oneout/'+str(cnt)+'_cycle5to1_switch.jpg', swt_img)
        cnt+=1
    print(classError)
    if cnt>=100:
        break

...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 20:33:28 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 18:19:41 2019
...
class generator(nn.Module):
    def __init__(self, n_blocks=6, norm_layer=nn.BatchNorm2d, use_dropout=False, padding_type='reflect'):
        ...
        for i in range(n_blocks):       # add ResNet blocks
            decoderModel += [ResnetBlock(2048, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout, use_bias=use_bias)]

# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 00:56:46 2019
...
from sleeveDataGen import FashionDataset
...
def main():
    ...
    for epoch in range(num_epochs):
        for i, data in enumerate(loader):
            ...
            if i>0 and (i+1) % 1900 == 0:
                torch.save(gen.state_dict(), './model/gen_sleeve_VGG_'+str(epoch+1)+'.ckpt')
